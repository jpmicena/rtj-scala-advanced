...
object ThreadCommunication extends App {
  ...
  /*
    ...
    2) create a deadlock (situation when multiple threads block each other and can't continue)
    3) create a livelock (situation when threads are active, but can't continue)
   */
